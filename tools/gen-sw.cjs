...
const FEAT = ['./js/feature/features.js', './js/feature/perfil.js', './js/feature/spirit.js', './js/feature/poems.js', './js/feature/palettes.js', './js/feature/zen.js', './js/feature/talismans.js', './js/feature/events.js'];
